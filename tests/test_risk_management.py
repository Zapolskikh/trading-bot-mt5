import pytest
from trading_bot_mt5.risk_management import RiskManagement, RiskConfig
...
def risk_manager(risk_config, mock_mt5_client):
    ...
    return RiskManagement(config=risk_config, mt5_client=mock_mt5_client)
...
def test_risk_manager_with_real_mt5_client(mt5_credentials):
    ...
    try:
        ...
        risk_manager = RiskManagement(config=config, mt5_client=client)
