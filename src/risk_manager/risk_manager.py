...
class RiskManager:
    ...
    def calculate_position_size(
        ...
        stop_distance_pips = self._calculate_stop_distance_pips(
            symbol_info, entry_price, stop_price
        )
    ...
    def _calculate_stop_distance_pips(
        self, symbol_info: dict, entry_price: float, stop_price: float
    ) -> float:
